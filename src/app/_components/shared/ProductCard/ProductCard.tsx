...
export default function ProductCard({ product, tableId }: { product: IProduct, tableId: number }) {
    ...
    return (
        <div onClick={() => dispatch(addproductToTable({ tableId, product }), dispatch(openTable({ tableId })))} className="bg-gray-200 hover:bg-gray-300 duration-200 active:scale-105 p-4 rounded-2xl shadow-md relative">
